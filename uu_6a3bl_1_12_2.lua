local Ha3BaHue_o6HoBJIeHu9l = "21 тестирование матрицы"
...
function forms:creat_TecTupoBaTb_MaTpucy_form(nick)
	...
	table_form.MaTpuca_box = MoHuTop_urpoka[nick].addBox(6, 44, 12, 12, black)
	table_form.MaTpuca_box2 = MoHuTop_urpoka[nick].addBox(7, 45, 10, 10, black)
	
	--чекбокс проверка 3
	table_form.npoBepka3_box = MoHuTop_urpoka[nick].addBox(6, 56, 12, 12, black)
	table_form.npoBepka3_box2 = MoHuTop_urpoka[nick].addBox(7, 57, 10, 10, black)
