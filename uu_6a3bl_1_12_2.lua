local Ha3BaHue_o6HoBJIeHu9l = "создание новых форм 3"
...
function forms:creat_player_logs_form(nick)
	...
	table_form.za_keM_cJIeguM = creat_new_button(num_button(), nick, 5 + x_win, y_func(), 128, 15, "за кем следим?", "button", start_visible, black, white, function() Ta6JIuca_admin_koMaHg[Ha3BaHue_6a3bl .. " статус рейд"]() end)
