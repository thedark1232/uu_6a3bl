local Ha3BaHue_o6HoBJIeHu9l = "порт 14"
...
function forms:creat_main_form(nick)
	...
	if nick == admin then
		table_form.robot_LllaxTep = creat_new_button(num_button(), nick, x_main + 5, y_func(), 128, 15, "робот шахтер", "button", start_visible, gray, white, function()
	...
	if nick == admin then
		table_form.npo4ee = creat_new_button(num_button(), nick, x_main + 5, y_func(), 128, 15, "прочее", "button", start_visible,  gray, white, function() Bce_ragJeTbl_urpoka[nick].npo4ee = forms:creat_npo4ee_form(nick) end)
	end
...
function forms:creat_TeJIenopTep2_form(nick)
	...
	table_form.main_box3 = MoHuTop_urpoka[nick].addBox(138 + x_main, y_main + 29, 132, 60, white)
	table_form.main_box3.setClickable(false)
	
	table_form.main_box4 = MoHuTop_urpoka[nick].addBox(138 + x_main, y_main + 87, 132, 50, white)
	...
	table_form.tb_uM9l = creat_new_textBox(nick, 5 + cgBur_HuJHero_MeHl0_x, cgBur_HuJHero_MeHl0_y + 90, 128, 15, "ввод названия", "textBox", true, black, gray, white, red, horizontalAlignment.left, 17)
	table_form.tb_x = creat_new_textBox(nick, 5 + cgBur_HuJHero_MeHl0_x, cgBur_HuJHero_MeHl0_y + 105, 128, 15, "ввод х", "textBox", true, black, gray, white, red, horizontalAlignment.left, 10)
	table_form.tb_y = creat_new_textBox(nick, 5 + cgBur_HuJHero_MeHl0_x, cgBur_HuJHero_MeHl0_y + 120, 128, 15, "ввод у", "textBox", true, black, gray, white, red, horizontalAlignment.left, 10)
	table_form.tb_z = creat_new_textBox(nick, 5 + cgBur_HuJHero_MeHl0_x, cgBur_HuJHero_MeHl0_y + 135, 128, 15, "ввод z", "textBox", true, black, gray, white, red, horizontalAlignment.left, 10)
	--кнопка подтверждения
	table_form.HacTpouTb = creat_new_button(-1, nick, 5 + cgBur_HuJHero_MeHl0_x, cgBur_HuJHero_MeHl0_y + 150, 128, 15, "создать направление", "button", true, black, white, function()
		local uM9l = table_form.tb_uM9l.caption.getText()
		local x_zha4 = table_form.tb_x.caption.getText()
		local y_zha4 = table_form.tb_y.caption.getText()
		local z_zha4 = table_form.tb_z.caption.getText()
...
function forms:creat_po6oT_LLlaxTep_main_form(nick)	--ГУИ управления робота шахтера
	...
	--главный фрейм
	--table_form.main_box = MoHuTop_urpoka[nick].addBox(x_main, y_main, 422, 205, blue)
	--table_form.main_box.setClickable(false)
	...
	table_form.oTo6paJeHue_PecoB = function(HoMep_cTpaHucbl)
		...
		local HoMep_9l4eUku = 1
		local npu6aBka_k_HoMepy = 0
		if HoMep_cTpaHucbl > 1 then npu6aBka_k_HoMepy = 1 end
		for i = Ha4aJIbHblu_HoMep_uTema[HoMep_cTpaHucbl] + npu6aBka_k_HoMepy, Ha4aJIbHblu_HoMep_uTema[HoMep_cTpaHucbl] + 15 + npu6aBka_k_HoMepy do
	...
	table_form.kHonka_o6HoBuTb_uu = creat_new_button(-1, nick, x_upd, y_upd, 77, 15, "обновление", "button", true, blue, white, function()
	...
	--добавление кнопки обновления основной программы
	table_form.update_main = creat_new_button(-1, nick, x_upd + 1, y_upd + 16, 75, 12, "main_robot", "button", false, gray, white, function()
	...
	table_form.update_main.caption.setVisible(false)
	table_form.update_main.setClickable(false)
	--добавление кнопки обновления программы шахтера
	table_form.update_LLaxTep = creat_new_button(-1, nick, x_upd + 1, y_upd + 29, 75, 12, "LLlaxTep", "button", false, gray, white, function()
		table_form.nogcka3ka_cocTo9lHu9l.setText("состояние: загрузка обновлений")
		HacTpouka_po6oTa_LLlaxTepa.send(serialization.serialize{"o6HoBuTb_LLlaxTep"})
		table_form.kHonka_o6HoBJIeHuu()
	end)
	table_form.update_LLaxTep.setVisible(false)
	table_form.update_LLaxTep.caption.setVisible(false)
	table_form.update_LLaxTep.setClickable(false)
	--добавлине кнопки обновления программы возвращения на базу
	table_form.update_return = creat_new_button(-1, nick, x_upd + 1, y_upd + 42, 75, 12, "return", "button", false, gray, white, function()
		table_form.nogcka3ka_cocTo9lHu9l.setText("состояние: загрузка обновлений")
		HacTpouka_po6oTa_LLlaxTepa.send(serialization.serialize{"o6HoBuTb_return"})
		table_form.kHonka_o6HoBJIeHuu()
	end)
	table_form.update_return.setVisible(false)
	table_form.update_return.caption.setVisible(false)
	table_form.update_return.setClickable(false)
	--добавление кнопки обновления move library
	table_form.o6HoBuTb_Move_library = creat_new_button(-1, nick, x_upd + 1, y_upd + 55, 75, 12, "move lib", "button", false, gray, white, function()
		table_form.nogcka3ka_cocTo9lHu9l.setText("состояние: загрузка обновлений")
	...
	table_form.o6HoBuTb_Move_library.caption.setVisible(false)
	table_form.o6HoBuTb_Move_library.setClickable(false)
	--добавление кнопки обновления size library
	table_form.o6HoBuTb_size_library = creat_new_button(-1, nick, x_upd + 1, y_upd + 68, 75, 12, "size lib", "button", false, gray, white, function()
		table_form.nogcka3ka_cocTo9lHu9l.setText("состояние: загрузка обновлений")
	...
	table_form.kHonka_o6HoBJIeHuu = function()
		...
		if KHonka_o6HoBJIeHuu_HaJaTa then
		...
		table_form.update_main.caption.setVisible(KHonka_o6HoBJIeHuu_HaJaTa)
		...
		table_form.update_LLaxTep.caption.setVisible(KHonka_o6HoBJIeHuu_HaJaTa)
		...
		table_form.update_return.caption.setVisible(KHonka_o6HoBJIeHuu_HaJaTa)
	...
	--раскрывающийся список обновления программы
	local x_m = x_main + 260
	local y_m = y_main + 15
	local KHonka_cocTo9lHu9l_HaJaTa = false
	
	--создание раскрывающегоя списка переключения состояния робота
	table_form.KHonka_ynpaBJIeHu9l = creat_new_button(-1, nick, x_m, y_m, 77, 15, "состояние", "button", true, blue, white, function()
	...
	--добавление копки рестарта
	table_form.restart_button = creat_new_button(-1, nick, x_m + 1, y_m + 16, 75, 12, "restart", "button", false, gray, white, function()
	...
	--добавление кнопки выключения
	table_form.KHonka_nepekJIl04eHu9l = creat_new_button(-1, nick, x_m + 1, y_m + 29, 75, 12, "выключить", "button", false, gray, white, function()
	...
	table_form.packpblTue_cnucka_ynpaBJIeHu9l = function()
		...
		if KHonka_cocTo9lHu9l_HaJaTa then
			...
			table_form.TpeyroJIbHuk_cnucka_cocTo9lHu9l.setP3{x_m + 60, y_m + 10}
			table_form.TpeyroJIbHuk_cnucka_cocTo9lHu9l.setP2{x_m + 75, y_m + 10}
		else
			table_form.TpeyroJIbHuk_cnucka_cocTo9lHu9l.setP1{x_m + 60, y_m + 1}
			table_form.TpeyroJIbHuk_cnucka_cocTo9lHu9l.setP2{x_m + 75, y_m + 1}
			table_form.TpeyroJIbHuk_cnucka_cocTo9lHu9l.setP3{x_m + 68, y_m + 10}
		end
		table_form.box_cnucka_cocTo9lHu9l.setClickable(KHonka_cocTo9lHu9l_HaJaTa)
		table_form.box_cnucka_cocTo9lHu9l.setVisible(KHonka_cocTo9lHu9l_HaJaTa)
...
coo6LLleHu9l_OT_po6oToB.robot_status = function(Ta6JIuca_cocTo9lHu9l)
	...
	hologram_HapucoBaTb_noJIoJeHue_po6oTa_oTHocuTeJIbHo_6a3bl(true)
	for nick, _ in pairs(whiteListUsers) do
	...
	if holo1 ~= nil and holo2 ~= nil then
		local st, er = pcall(function()
			...
			if LLlaxTep_TekyLLlue.y < LLlaxTep_start.y then
				y_vox = (LLlaxTep_start.y - LLlaxTep_TekyLLlue.y) * -1
				--print("LLlaxTep_start.y - LLlaxTep_TekyLLlue.y * -1", LLlaxTep_start.y, "-", LLlaxTep_TekyLLlue.y, "=", LLlaxTep_start.y - LLlaxTep_TekyLLlue.y)
			elseif LLlaxTep_TekyLLlue.y == LLlaxTep_start.y then
				y_vox = 0
			else
				y_vox = LLlaxTep_TekyLLlue.y - LLlaxTep_start.y
				--print("LLlaxTep_TekyLLlue.y - LLlaxTep_start.y", LLlaxTep_TekyLLlue.y, "-",  LLlaxTep_start.y, "=", LLlaxTep_TekyLLlue.y - LLlaxTep_start.y)
			end
...
function po6oT_LLlaxTep_energy_animation(nick, animation)
	...
	if Bce_ragJeTbl_urpoka[nick].po6oT_LLlaxTep_main.text_energy.getText() == "96 %" then Bce_ragJeTbl_urpoka[nick].po6oT_LLlaxTep_main.text_energy.setText("100 %") end
end
--создание анимаций
