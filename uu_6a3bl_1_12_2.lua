local Ha3BaHue_o6HoBJIeHu9l = "порт 37"
...
function forms:creat_main_form(nick)
	...
	table_form.TeJIenopTep2 = creat_new_button(num_button(), nick, x_main + 5, y_func(), 128, 15, "телепортер2", "button", start_visible,  black, white, function()
...
function forms:creat_TeJIenopTep2_form(nick)
	...
	table_form.main_box4 = MoHuTop_urpoka[nick].addBox(138 + x_main, y_main + 88, 132, 113, white)
