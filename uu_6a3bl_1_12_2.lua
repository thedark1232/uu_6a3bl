local Ha3BaHue_o6HoBJIeHu9l = "26 крафт на матрице"
...
function forms:creat_MaTpuca_3anucb_pecenTa_form(nick)
	...
	if #Ta6JIuca_nbegecTaJIoB ~= 0 then
		...
		if type(item) == "table" then
			...
			table_form.textBox_BBog_Ha3BaHu9l_pecenTa = creat_new_textBox(nick, 10, 200, 101, 15, "ввод названия рецепта", "textBox", true, black, gray, white, red, horizontalAlignment.left, 50)
