...
local cMellleHue_Muual0lllero_coo6llleHu9l_no_x = 30
...
while not_exit do
	...
	if Tekyllluu_HoMep_CTpoku > KoHe4Hblu_HoMep_cTpoku then
		...
		for j = 1, 5 do
			...
			HanuCaTb_6oJIblllou_TekcT(cMellleHue_Muual0lllero_coo6llleHu9l_no_x, cMellleHue_Muual0lllero_coo6llleHu9l_no_y, Tekyllluu_TekcT, "setGreen")
			os.sleep(0.25)
			alphabet["стереть"](cMellleHue_Muual0lllero_coo6llleHu9l_no_x, cMellleHue_Muual0lllero_coo6llleHu9l_no_y, 102)
		end
	end
end
